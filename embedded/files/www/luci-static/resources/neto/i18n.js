...
var ru = {
	...
	'Outbound latency test': 'Тест задержки исходящих',
	'Test latency': 'Проверить задержку',
	'Testing…': 'Проверка…',
	'Testing all outbounds. This may take several minutes for a large subscription…': 'Проверяются все исходящие. Для большой подписки это может занять несколько минут…',
	'Latency test failed': 'Не удалось проверить задержку',
	'Invalid latency test response': 'Некорректный ответ теста задержки',
	'Latency': 'Задержка',
	'Reachable': 'Доступен',
	'Failed': 'Ошибка',
	'Results are sorted from the lowest latency to the highest. Failed servers are shown last.': 'Результаты отсортированы от меньшей задержки к большей. Недоступные серверы показаны в конце.',
	'Test target': 'Адрес проверки',
	'Action': 'Действие',
	'Outbound': 'Исходящий',
